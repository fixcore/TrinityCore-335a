...
public:
    ...
    static bool OnGossipSelectTicTacToeHuman(Player* player, Creature* creature, uint32 sender, uint32 action, NpcTicTacToeInfo const* NpcTicTacToeGameExistFound)
    {
        ...
        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Game '" + COLOR_RED + "" + NpcTicTacToeGameExist->namePlayer01 + "|r' Vs '" + COLOR_BLUE + "" + NpcTicTacToeGameExist->namePlayer02 + "|r' started.\n", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 60);
        ...
        else
        {
            ...
            if (NpcTicTacToeGameExist->gameStatus == 20 || NpcTicTacToeGameExist->gameStatus == 21)
            {
                ...
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TABARD, "Erase this game ?\n", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
    ...
    bool OnGossipHello(Player* player, Creature* creature) override
    {
        ...
        if (!NpcTicTacToeData.empty())
        {
            ...
            for (std::map<ObjectGuid, NpcTicTacToeInfo>::const_iterator i = NpcTicTacToeData.begin(); i != NpcTicTacToeData.end(); ++i)
            {
                if (i->second.guidPlayer01 == player->GetGUID() || i->second.guidPlayer02 == player->GetGUID())
                {
                    ...
                    {
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TABARD, "You are already in one game setup.\n", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 20);
                    }
                    else if (i->second.gameStatus == 2 && i->second.guidPlayer01 == player->GetGUID())
                    {
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TABARD, "You are already in one game created.\n", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 56);
                    }
                    else if (i->second.gameStatus < 2 && i->second.guidPlayer02 == player->GetGUID() && i->second.gameTypeSelected == 1)
                    {
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TALK, "You are already in one game setup (create by '" + COLOR_RED + "" + i->second.namePlayer01 + "|r').\n", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                    }
                    else if (i->second.gameStatus == 2 && i->second.guidPlayer02 == player->GetGUID() && i->second.gameTypeSelected == 1)
                    {
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TABARD, "You are already in one game created by '" + COLOR_RED + "" + i->second.namePlayer01 + "|r', join it ?\n", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 56);
                    }
                    else if (i->second.gameStatus >= 5 && i->second.gameStatus < 20)
                    {
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TABARD, "You are already in an existing game '" + COLOR_RED + "" + i->second.namePlayer01 + "|r' Vs '" + COLOR_BLUE + "" + i->second.namePlayer02 + "|r', join it ?\n", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 60);
                    }
                    else if (i->second.gameStatus >= 20)
                    {
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_VENDOR, "This game '" + COLOR_RED + "" + i->second.namePlayer01 + "|r' Vs '" + COLOR_BLUE + "" + i->second.namePlayer02 + "|r' it's already done.\n", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 60);
                    }

                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TABARD, "Erase your existing game ?\n", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
                    break;
                }
            }
        }
        ...
        if (gameExistFound == false)
        {
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TALK, "No game already exist with you, for start new one you need first choose a theme.\n", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 15);
        }
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action)
    {
        ...
        switch (action)
        {
            ...
            case GOSSIP_ACTION_INFO_DEF + 3:
            {
                ...
                player->ADD_GOSSIP_ITEM_EXTENDED(GOSSIP_ICON_TALK, "You have an existing game '" + COLOR_RED + "" + NpcTicTacToeGameExist->namePlayer01 + "|r' Vs '" + COLOR_BLUE + "" + NpcTicTacToeGameExist->namePlayer02 + "|r', do you want to erase it ?\n", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4, "Are you sure ?", 0, false);
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TALK, "\nMain menu", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                player->SEND_GOSSIP_MENU(GOSSIP_MENU_TICTACTOE_INGAME, creature->GetGUID());
            } break;
            ...
            case GOSSIP_ACTION_INFO_DEF + 10:
            {
                ...
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TALK, "Tic Tac Toe game rules : The player who succeeds in placing three of their marks in a " + COLOR_GREEN + "horizontal|r, " + COLOR_GREEN + "vertical|r, or " + COLOR_GREEN + "diagonal|r row wins the game. Lines are letters (ABC) and columns are numbers (123).\nThis is an exemple of game win by " + GetIconePathBySize(GetIconeNameByPlayerTheme(Path_Icon, winPlayerExemple01, themeExemple), 45) + ":\n", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
            ...
            {
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TALK, "Select theme you want play with :\n", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 15);
            ...
            case GOSSIP_ACTION_INFO_DEF + 56:
            {
                ...
                {
                    case 1:
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "If you " + COLOR_GREEN + "win|r this game, you will have " + std::to_string(MONEY_WIN_GAME_HUMAN / 10000) + " Gold.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 56);
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "If you " + COLOR_RED + "loose|r this game, you will loose " + std::to_string(MONEY_LOOSE_GAME_HUMAN / 10000) + " Gold.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 56);
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "If game " + COLOR_WHITE + "draw|r, you will have " + std::to_string(MONEY_DRAW_GAME_HUMAN / 10000) + " Gold.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 56);
                        break;
                    case 2:
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "If you " + COLOR_GREEN + "win|r this game, you will have " + std::to_string(MONEY_WIN_GAME_NPC / 10000) + " Gold.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 56);
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "If you " + COLOR_RED + "loose|r this game, you will loose " + std::to_string(MONEY_LOOSE_GAME_NPC / 10000) + " Gold.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 56);
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "If game " + COLOR_WHITE + "draw|r, you will have " + std::to_string(MONEY_DRAW_GAME_NPC / 10000) + " Gold.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 56);
                        break;
                    case 3:
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "If you " + COLOR_GREEN + "win|r this game, you will have " + std::to_string(MONEY_WIN_GAME_IA_NPC / 10000) + " Gold.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 56);
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "If you " + COLOR_RED + "loose|r this game, you will loose " + std::to_string(MONEY_LOOSE_GAME_IA_NPC / 10000) + " Gold.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 56);
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "If game " + COLOR_WHITE + "draw|r, you will have " + std::to_string(MONEY_DRAW_GAME_IA_NPC / 10000) + " Gold.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 56);
                        break;
                }
