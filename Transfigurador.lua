...
local SlotNames = {
    [EQUIPMENT_SLOT_HEAD      ] = {"Cabeza",         nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_SHOULDERS ] = {"Espalda",    nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_BODY      ] = {"Camisa",        nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_CHEST     ] = {"Pecho",        nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_WAIST     ] = {"Cintura",        nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_LEGS      ] = {"Piernas",         nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_FEET      ] = {"Pies",         nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_WRISTS    ] = {"Muñecas",       nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_HANDS     ] = {"Manos",        nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_BACK      ] = {"Atras",         nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_MAINHAND  ] = {"Una mano",    nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_OFFHAND   ] = {"Mano opcional",     nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_RANGED    ] = {"A distancia",       nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_TABARD    ] = {"Tabardo",       nil, nil, nil, nil, nil, nil, nil, nil},
}
local Locales = {
    {"Actualizar menu", nil, nil, nil, nil, nil, nil, nil, nil},
    {"Eliminar todas las transfiguraciones", nil, nil, nil, nil, nil, nil, nil, nil},
    {"Eliminar transfiguraciones equipadas?", nil, nil, nil, nil, nil, nil, nil, nil},
    {"El uso de este artiulo para transfigurar se unira a ti y al hacerlo no son reembolsables ni transladables.\nQuieres continuar?", nil, nil, nil, nil, nil, nil, nil, nil},
    {"Remove transmogrification from %s?", nil, nil, nil, nil, nil, nil, nil, nil},
    {"Atras..", nil, nil, nil, nil, nil, nil, nil, nil},
    {"Eliminar transfiguracion", nil, nil, nil, nil, nil, nil, nil, nil},
    {"transfiguraciones retiradas de objetos equipados", nil, nil, nil, nil, nil, nil, nil, nil},
    {"No tiene articulos transfigurados equipados", nil, nil, nil, nil, nil, nil, nil, nil},
    {"%s transfiguracion eliminada", nil, nil, nil, nil, nil, nil, nil, nil},
    {"No se encuentra una transfiguracion en %s", nil, nil, nil, nil, nil, nil, nil, nil},
    {"%s Transfigurado!", nil, nil, nil, nil, nil, nil, nil, nil},
    {"Los elementos seleccionados no son adecuados", nil, nil, nil, nil, nil, nil, nil, nil},
    {"Elemento seleccionado no existe", nil, nil, nil, nil, nil, nil, nil, nil},
    {"Equipo ranura esta vacia", nil, nil, nil, nil, nil, nil, nil, nil},
    {"Usted no tiene suficiente %ss", nil, nil, nil, nil, nil, nil, nil, nil},
    {"Dinero insuficiente", nil, nil, nil, nil, nil, nil, nil, nil},
}
...
print("Eliminando entradas de transfiguración...")
